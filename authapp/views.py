...
def test_json(request):
    if request.method == 'POST':
        ...
        if email is None:
            return JsonResponse([{'resCode': 1, 'resaCode': 2},{'resCode': 'string','hello':'my_friend', 'resaCodeaa': 2}, {'resCode': 3, 'resaCode': 4}], safe=False)
            ...
            if form.is_valid():
                ...
                try:
                    with transaction.atomic():
                        ...
                        new_wallet = Wallet.objects.create(user=new_user_create)
