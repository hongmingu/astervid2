...
class Post(models.Model):
    ...
    ping_id = models.CharField(max_length=34, null=True, blank=True, default=None)
    # opt = models.CharField(max_length=34, null=True, blank=True, default=None)
    text = models.TextField(max_length=2000, null=True, blank=True, default=None)
    ping_text = models.TextField(max_length=1000, null=True, blank=True, default=None)
